      ...
      {lines.map((line, i) => {
        if (
          ...
          return (
            <div
              key={i}
              className="px-3 py-0.5 bg-bg text-text-tertiary font-semibold"
            >
              {line}
            </div>
          );
        ...
        if (line.startsWith('@@')) {
          return (
            <div
              key={i}
              className="px-3 py-0.5 bg-blue-50 text-blue-700"
            >
              {line}
            </div>
          );
        ...
        if (line.startsWith('-')) {
          return (
            <div
              key={i}
              className="flex bg-red-50 text-red-800 border-l-[3px] border-l-red-500"
            >
              <span className="w-8 shrink-0 text-right pr-2 text-text-tertiary select-none">
                {i + 1}
              </span>
